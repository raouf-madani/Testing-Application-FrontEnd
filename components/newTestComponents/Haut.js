...
const Haut = ({
  ...
  const initial_mise_placefrom_values = {
    ...
    Multiplicateur_Amperes_P1: mise_data.Perte_a_Vide.Multiplicateur_amperes_P1,
    ...
    Multiplicateur_Amperes_P2: mise_data.Perte_a_Vide.Multiplicateur_amperes_P2,
    ...
    <Collapse
      ...
      <Panel
        ...
        <Row className="flex-div" style={{justifyContent: 'center'}}>
          {mise_data.state == true && (
            <Button onClick={() => setmiseenplacemodal(true)} type="link">
