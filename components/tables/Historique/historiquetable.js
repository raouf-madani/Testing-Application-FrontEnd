    ...
    <Table borderless hover>
      <thead>
        ...
        <tr style={{backgroundColor: '#174961'}}>
          ...
          <td>#</td>
          <td>
            {Math.round((sumEPN1WATTS / filteredEssais.length) * 100) / 100}
          </td>
          <td>
            {Math.round((sumEPN2WATTS / filteredEssais.length) * 100) / 100}{' '}
          </td>
          <td>
            {Math.round((sumTEMPSESSAI / filteredEssais.length) * 100) / 100}
          </td>
          <td>
            {Math.round((sumPERTESAVIDE / filteredEssais.length) * 100) / 100}
          </td>
          <td>#</td>
          <td>
            {Math.round((sumDESTRUTION / filteredEssais.length) * 100) / 100}
          </td>
          <td>
            {Math.round((sumEXC1amp / filteredEssais.length) * 100) / 100}
          </td>
          <td>
            {Math.round((sumEXC1GAR / filteredEssais.length) * 100) / 100}
          </td>
        </tr>
      </thead>
      <tbody>
